...
def cmd(c: str, *args: object, **kw: object) -> tuple[str, str]: ...
def find_line_with(prefix: str, output: str) -> str | None: ...
def hg_cmd(hgcmd: str) -> list[dict[str, Any]]: ...  # Any: mercurial log entries are dynamic
...
class FilteredRSync:
    ...
    def add_target(self, gateway: object, destdir: str, finishedcallback: Callable[[], None] | None = ...) -> None: ...
