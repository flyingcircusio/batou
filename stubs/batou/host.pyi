...
class Host:
    ...
    def __init__(self, name: str, environment: Environment, config: dict[str, Any] | ConfigSection = ...) -> None: ...
    @property
...
class RPCWrapper:
    ...
    def __getattr__(self, name: str) -> Callable[..., Any]: ...  # Any: dynamic RPC methods
