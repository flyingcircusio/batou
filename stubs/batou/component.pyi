...
class ComponentDefinition:
    ...
    def __init__(self, factory: Callable[[], Component], filename: str | None = ..., defdir: str | None = ...) -> None: ...
...
class Attribute[T]:
    ...
    @overload
    def __get__(self, obj: Any, objtype: type | None = ...) -> T: ...  # Any: descriptor protocol allows any owner
    @overload
    def __init__(
        self,
        conversion: type[T] | str | Callable[..., T],
    ...
    @overload
    def __init__(self, *, default: str | ConfigString | None = ..., expand: bool = ..., map: bool = ...) -> None: ...
    def __set__(self, obj: Any, value: T) -> None: ...  # Any: descriptor protocol
    def __set_name__(self, owner: type, name: str) -> None: ...
    def convert_list(self, value: str) -> list[str]: ...
    def convert_literal(self, value: str) -> Any: ...  # Any: depends on conversion target
    def from_config_string(self, obj: Any, value: ConfigString) -> Any: ...  # Any: descriptor protocol
...
class Component:
    ...
    def _template_args(
        self, component: Component | None = ..., **kw: Any
    ) -> dict[str, Any]: ...  # Any: template arguments heterogeneous
    def assert_cmd(self, *args: str, **kw: object) -> None: ...
    def assert_component_is_current(self, requirements: Component | list[Component] = ..., **kw: object) -> None: ...
    def assert_file_is_current(self, reference: str, requirements: list[str] = ..., **kw: object) -> None: ...
    ...
    def expand(self, string: str | ConfigString, component: Component | None = ..., **kw: Any) -> str: ...
    @property
    def host(self) -> Host: ...
    ...
    def require(
        self, key: str, host: Host | None = ..., strict: bool = ..., reverse: bool = ..., dirty: bool = ...
    ) -> list[object]: ...
    def require_one(
        self, key: str, host: Host | None = ..., strict: bool = ..., reverse: bool = ..., dirty: bool = ...
    ) -> object: ...
...
def check_event_scope(scope: Literal["*", "precursor"], source: Component, target: Component) -> bool: ...
