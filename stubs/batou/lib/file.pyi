...
def limited_buffer(
    iterator: Iterator[str], limit: int, lead: int, separator: str = ..., logdir: str = ...
...
class Presence(Component):
    ...
    def __init__(self, path: str | None = ..., *, leading: bool = ...) -> None: ...
    @typing.override
    def configure(self) -> None: ...
    @typing.override
    def last_updated(self, key: str = ...) -> float | None: ...
...
class Owner(FileComponent):
    ...
    def __init__(self, path: str | None = ..., *, leading: bool = ..., owner: str | int | None = ...) -> None: ...
    @typing.override
    def update(self) -> None: ...
    @typing.override
    def verify(self) -> None: ...
...
class Group(FileComponent):
    ...
    def __init__(self, path: str | None = ..., *, leading: bool = ..., group: str | int | None = ...) -> None: ...
    @typing.override
    def update(self) -> None: ...
    @typing.override
    def verify(self) -> None: ...
...
class Symlink(Component):
    ...
    def __init__(self, target: str | None = ..., *, source: str | None = ...) -> None: ...
    @typing.override
    def configure(self) -> None: ...
    @typing.override
    def update(self) -> None: ...
