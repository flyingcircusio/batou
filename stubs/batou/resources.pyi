...
class Resources:
    ...
    def copy_resources(self) -> dict[str, dict[RootComponent, list[object]]]: ...
    def get(self, key: str, host: Host | None = ...) -> list[object]: ...
    def get_dependency_graph(self) -> defaultdict[RootComponent, set[RootComponent]]: ...
    def provide(self, root: RootComponent, key: str, value: object) -> None: ...
    def require(
        self, root: RootComponent, key: str, host: Host | None = ..., strict: bool = ..., reverse: bool = ..., dirty: bool = ...
    ) -> list[object]: ...
    ...
    @property
    def unsatisfied_keys_and_components(self) -> dict[tuple[str, str | None], set[RootComponent]]: ...
    @property
    def unused(self) -> dict[str, dict[RootComponent, list[object]]]: ...
...
class Subscription:
    ...
    def __init__(self, root: RootComponent, strict: bool, host: Host | None, reverse: bool, dirty: bool) -> None: ...
