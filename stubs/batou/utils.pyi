...
def call_with_optional_args(func: Callable[..., object], **kw: object) -> object: ...
@overload
def cmd(
    cmd: str | list[str],
    silent: bool = ...,
...
def dict_merge(a: dict[str, Any], b: dict[str, Any]) -> dict[str, Any]: ...  # Any: merges heterogeneous dicts
def ensure_graph_data(graph: defaultdict[object, set[object]]) -> defaultdict[object, set[object]]: ...
...
def locked(filename: str, exit_on_failure: bool = ...) -> AbstractContextManager[None]: ...
...
def self_id() -> str: ...
def topological_sort(graph: defaultdict[object, set[object]]) -> list[object]: ...
